                ...
                <div class="row">
                    <div class="col-md-12">
                     <h2>Blog administrator</h2>
                          ...
                          {{Form::open(array('url' => 'supersecret/add', 'method' => 'post'))}}
                        <h3>Add post</h3>
                        <hr/>
                        <div class="row">
                            <div class="col-md-4">
                              {{Form::label('title', 'Title')}}
                              {{Form::text('title', '', array('class' => 'form-control', 'placeholder' => 'Insert a post title...'))}}
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-2">
                              <div class="form-group slug_class">
                                ...
                                {{Form::text('slug', '', array('class' => 'form-control', 'placeholder' => 'lorem-ipsum'))}}
                              </div>  
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            {{Form::submit('Add post', array('class' => 'btn btn-success', 'id' => 'btn_add'))}}
                          </div>
                        </div>
